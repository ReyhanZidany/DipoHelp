...
<body class="bg-blue-100 flex items-center justify-center min-h-screen">
    <div class="bg-white rounded-lg shadow-lg p-8 md:p-16 flex flex-col md:flex-row items-center md:space-x-16">
        <!-- Left Section: Image -->
        ...
        <div class="w-full max-w-md">
            ...
            <div class="flex space-x-4 mb-4">
                <!-- Pengguna Button -->
                <button class="flex items-center justify-center w-1/2 py-2 border border-blue-500 text-blue-500 rounded-lg bg-blue-100 hover:bg-blue-300">
                    <i class="fas fa-user-tie mr-2"></i> Pengguna
                </button>

                <!-- Admin Button with redirection -->
                <a href="loginadmin" class="flex items-center justify-center w-1/2 py-2 border border-blue-500 text-blue-500 rounded-lg hover:bg-blue-300">
